        ...
        <form className={styled.signUpForm} onSubmit={submitHandler}>
          ...
          <div className={styled.inputSignUp}>
            ...
            <input
              ...
              placeholder="مثال: محدثه علیجانی"
              type="text"
              name="name"
              value={data.name}
          ...
          <div className={styled.inputSignUp}>
            ...
            <input
              className={
                errors.email && isSelected.email && styled.inputInvalid
              }
              placeholder="مثال: alijani@ex.com"
              type="email"
              name="email"
              value={data.email}
              onChange={changeHandler}
          ...
          <div className={styled.inputSignUp}>
            ...
            <input
              className={
                errors.password && isSelected.password && styled.inputInvalid
              }
              placeholder="َمثال: AliJaNi1381"
              type="password"
              name="password"
              value={data.password}
              onChange={changeHandler}
              onBlur={blurHandler}
            />
            {errors.password && isSelected.password && (
          ...
          <div className={styled.inputSignUp}>
            ...
            <input
              className={
                ...
                isSelected.confirmPassword &&
                styled.inputInvalid
              }
              placeholder="مثال: AliJaNi1381"
              type="password"
              ...
              onBlur={blurHandler}
            />
            {errors.confirmPassword && isSelected.confirmPassword && (
          ...
          <div className={styled.checkboxSignUp}>
            ...
            {errors.isAccepted && isSelected.isAccepted && (
